...
<body>
    ...
    @include 'config.php';
     if(isset($_POST['submit'])){
        $email = $_POST['email'];
        $password = $_POST['pass'];
        $emailquery = "SELECT * FROM user WHERE email ='$email' AND password ='$password'";
...
<form action="<?php $_SERVER['PHP_SELF'];?>" style="border:1px solid #ccc" method="post">
  <div class="container">
    ...
    <p> Do not have account <a href="reg_user.php" style="color:dodgerblue">create account</a>.</p>
